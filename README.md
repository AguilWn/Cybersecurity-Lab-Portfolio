...
## Author: [Wennymar Aguil] Date: January 2026 Category: Virtualization / Systems Administration / Security Foundations
...
Networking: VirtualBox Internal Networking / NAT Network

Documentation: Draw.io (for network diagrams), Markdown
